...
// Type: StreamDataLogger.IStreamEventProducer
...
{
  event IStreamEventProducer.NewBufferAvailableEventHandler NewBufferAvailable;

  void CancelStreamAsync();

  event IStreamEventProducer.StreamFinishedEventHandler StreamFinished;

  delegate void NewBufferAvailableEventHandler(int BufferCount);

  delegate void StreamFinishedEventHandler();
}
