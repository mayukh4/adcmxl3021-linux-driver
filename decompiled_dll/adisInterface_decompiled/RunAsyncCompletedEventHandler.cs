...
// Type: adisInterface.RunAsyncCompletedEventHandler
...
/// <summary>Type for the RunAsyncCompleted handler routine.</summary>
/// <param name="sender"></param>
/// <param name="e"></param>
/// <remarks></remarks>
public delegate void RunAsyncCompletedEventHandler(object sender, RunAsyncCompletedEventArgs e);
