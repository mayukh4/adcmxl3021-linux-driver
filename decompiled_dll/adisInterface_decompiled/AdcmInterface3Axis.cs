...
// Type: adisInterface.AdcmInterface3Axis
...
public class AdcmInterface3Axis(IRegInterface adis) : AdcmInterfaceBase(adis, (BurstBase) null)
{
  ...
  /// <returns></returns>
  protected override int RealTimeSamplingFrameSize => 100;
  ...
  public AdcmInterface3Axis(IRegInterface adis, BurstBase burstMode)
    : this(adis)
  {
  ...
  protected override void AddTransletedRtsFrameToList(ushort[] rtsFrame, List<ushort> list)
  {
    ...
    do
    {
      list.Add(rtsFrame[checked (num + 1)]);
      list.Add(rtsFrame[checked (num + 33)]);
      list.Add(rtsFrame[checked (num + 65)]);
      list.Add(rtsFrame[97]);
      list.Add(rtsFrame[98]);
      list.Add(rtsFrame[99]);
      list.Add(rtsFrame[0]);
      checked { ++num; }
    }
    while (num <= 31 /*0x1F*/);
