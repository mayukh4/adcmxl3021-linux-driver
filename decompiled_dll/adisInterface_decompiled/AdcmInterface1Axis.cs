...
// Type: adisInterface.AdcmInterface1Axis
...
public class AdcmInterface1Axis(IRegInterface adis) : AdcmInterfaceBase(adis, (BurstBase) null)
{
  ...
  /// <returns></returns>
  protected override int RealTimeSamplingFrameSize => 44;
  ...
  public AdcmInterface1Axis(IRegInterface adis, BurstBase burstMode)
    : this(adis)
  {
  ...
  protected override void AddTransletedRtsFrameToList(ushort[] rtsFrame, List<ushort> list)
  {
    ...
    do
    {
      ...
      list.Add(rtsFrame[41]);
      list.Add(rtsFrame[42]);
      list.Add(rtsFrame[43]);
      list.Add(rtsFrame[8]);
      checked { ++num; }
    }
    while (num <= 31 /*0x1F*/);
